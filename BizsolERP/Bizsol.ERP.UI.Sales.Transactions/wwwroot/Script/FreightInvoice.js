...
const FI_GRID_HEADERS = [
    ...
    { key: 'grNo', label: 'GR/LR No.', colClass: 'fi-col-grn', thClass: 'fi-col-grn', sortType: 'text', apiKeys: ['GR No'] },
    { key: 'grDate', label: 'GR/LR Date', colClass: 'fi-col-date', thClass: 'center fi-col-date', sortType: 'date', apiKeys: ['GR Date'] },
