        ...
        <div class="col-md-12" style="margin: 0 auto">
            <div class="row">
                <div class="col-md-6 col-sm-6 mt-1 toolbar toolbar1">
                    <button data-toggle="tooltip" data-placement="top" title="FIRST" id="First" onclick="First()" class="btn-height btn btn-success nav-btn">
                        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true" width="24" height="24" class="svg-icon">
                            <path d="M18.41 16.59L13.82 12l4.59-4.59L17 6l-6 6 6 6zM6 6h2v12H6z"></path>
                        </svg>
                    </button>
                    <button data-toggle="tooltip" data-placement="top" title="PREVIOUS" id="Previous" onclick="Previous()" class="btn-height btn btn-success nav-btn">
                        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true" width="24" height="24" class="svg-icon">
                            <path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path>
                        </svg>
                    </button>
                    <button data-toggle="tooltip" data-placement="top" title="NEXT" id="Next" onclick="Next()" class="btn-height btn btn-success nav-btn">
                        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true" width="24" height="24" class="svg-icon">
                            <path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path>
                        </svg>
                    </button>
                    <button data-toggle="tooltip" data-placement="top" title="LAST" id="Last" onclick="Last()" class="btn-height btn btn-success nav-btn">
                        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true" width="24" height="24" class="svg-icon">
                ...
                <div class="col-md-6 col-sm-6 toolbar mt-1">
                    <button data-toggle="tooltip" data-placement="top" title="SAVE" id="btnSave" onclick="Save()" class="btn-height btn btn-success nav-btn">
                    ...
                    <button data-toggle="tooltip" data-placement="top" title="DELETE" id="btnDelete" onclick="Delete()" class="btn-height btn btn-danger nav-btn">
                        <svg width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);" class="svg-icon">
                            <path d="M6 7H5v13a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7H6zm4 12H8v-9h2v9zm6 0h-2v-9h2v9zm.618-15L15 2H9L7.382 4H3v2h18V4z"></path>
                        </svg>
                    </button>
                    <button data-toggle="tooltip" data-placement="top" title="BACK" id="btnBack" onclick="Back()" class="btn-height btn btn-success nav-btn">
                        <svg width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);" class="svg-icon">
                            <path d="M19 21a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14zM12 7v4h5v2h-5v4l-5-5 5-5z"></path>
                        </svg>
                    </button>
                    <button data-toggle="tooltip" data-placement="top" title="PRINT" id="btnPrint" onclick="Print()" class="btn-height btn btn-success nav-btn">
                    ...
                    <button data-toggle="tooltip" data-placement="top" title="VIEW" id="btnAttachment" onclick="ViewAttachment()" class="btn-height btn btn-success nav-btn">
                        <svg width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);" class="svg-icon">
                    ...
                    <button data-toggle="tooltip" data-placement="top" title="VERIFY" id="btnVerify" onclick="Verify()" class="btn-height btn btn-success nav-btn">
                        <svg width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);" class="svg-icon">
                    ...
                    <button data-toggle="tooltip" data-placement="top" title="OTHER" id="btnOther" onclick="Other()" class="btn-height btn btn-success nav-btn">
                        <svg width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);" class="svg-icon">
