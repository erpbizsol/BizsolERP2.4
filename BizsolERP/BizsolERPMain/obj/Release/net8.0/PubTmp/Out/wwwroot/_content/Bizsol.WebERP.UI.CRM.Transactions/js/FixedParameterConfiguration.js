import { FixedParameterConfigurationService } from '../../Bizsol.WebERP.UI.Shared/js/JSServices/FixedParameterConfigurationService.js';
...
function SaveData() {
    ...
    FixedParameterConfigurationService.SaveCRMFixedParameterConfig(FixedParameterConfigData).then(function (response) {
...
function GetStockOptionList() {
    ...
    FixedParameterConfigurationService.GetStockOptionList().then(function (response) {
        var defaultValue = '';
